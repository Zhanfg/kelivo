...
void main() {
  group('StoryCapabilityEpoch', () {
    test('canonical ordering prevents Set/Map order from changing cache key', () {
    ...
    test('worldline or scene epoch change invalidates stable prefix identity', () {
    ...
    test('duplicate capability ids are rejected instead of silently reordered', () {
      expect(
